            ...
            HStack(spacing: 12) {
                VStack(alignment: .leading, spacing: 6) {
                    ...
                    if activeStates.contains("SCREEN") {
                        fpsText = "144 FPS / 144Hz ⚡"; fpsColor = CyberGreen
                    } else if activeStates.contains("BUFF_120HZ") {
                        fpsText = "120 FPS / 120Hz ✨"; fpsColor = CyberGreen
                    } else {
                        fpsText = "60 FPS / 60Hz"; fpsColor = CyberIceYellow
                    }
                    Text("Refresh rate output: \(fpsText)")
                        .font(.system(size: 13, weight: .medium)).foregroundColor(fpsColor)
                }
