...
struct DashboardView: View {
    ...
    let vipFeaturesList: [ModFeature] = [
        ...
        ModFeature(id: "ANCHOR", name: "ANCHOR AIM 👑", description: "Ghìn Tâm Tự Động [VIP Only]", isVipOnly: true)
    ]
    ...
    var body: some View {
        ZStack {
            ...
            ScrollView(showsIndicators: false) {
                VStack(spacing: 0) {
                    Color.clear.frame(height: safeTop + h * 0.01)
                    ...
                    Color.clear.frame(height: h * 0.02)
                    ...
                    Color.clear.frame(height: safeBottom + h * 0.02)
                }
            }
        }
