...
struct AdvancedTunerView: View {
    ...
    var h: CGFloat = UIScreen.main.bounds.height
    var scale: CGFloat = min(max(UIScreen.main.bounds.width / 375, 0.75), 1.5)
    var hp: CGFloat = UIScreen.main.bounds.width * 0.055
