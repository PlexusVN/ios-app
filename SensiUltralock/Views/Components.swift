            ...
            HStack(spacing: 10) {
                ...
                VStack(alignment: .leading, spacing: 1) {
                    Text(platform.uppercased())
                        .font(.system(size: 9, weight: .bold)).foregroundColor(CyberTextSecondary).tracking(0.5)
                    Text(value)
    ...
    var body: some View {
        ...
        VStack(alignment: .leading, spacing: 14) {
            Text("ADVANCED TUNER HUD")
                .font(.system(size: 12, weight: .bold)).foregroundColor(CyberIceYellow).tracking(1.2)
                ...
                HStack(spacing: 10) {
                    ...
                    VStack(alignment: .leading, spacing: 2) {
                        Text("QUẢN TRỊ VIÊN HỆ THỐNG")
                            ...
                            .shadow(color: CyberYellow.opacity(0.5), radius: 4).tracking(1.2)
