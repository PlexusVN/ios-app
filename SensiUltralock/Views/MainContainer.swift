            ...
            HStack {
                ...
                ZStack {
                    Circle()
                        ...
                        .overlay(
                            Circle().stroke(viewModel.isVIP ? CyberTheme.cyberGold : CyberTheme.textSecondary, lineWidth: 1)
                        )
                    Text(viewModel.isVIP ? "👑" : "👤")
                        .font(.system(size: 14))
                }
                .cyberGlow(viewModel.isVIP ? CyberTheme.cyberPurple : .clear, radius: 6, opacity: 0.5)
            }
